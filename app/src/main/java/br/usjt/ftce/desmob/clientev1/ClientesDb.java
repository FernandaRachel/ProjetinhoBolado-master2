...
public class ClientesDb {
    ...
    public void insereCliente(ArrayList<Cliente> clientes){
        ...
        for(Cliente cliente: clientes) {
            ...
            values.put(ClientesContract.ClienteEntry.COLUMN_NAME_CLIENTE_FONE, cliente.getNome());
            values.put(ClientesContract.ClienteEntry.COLUMN_NAME_CLIENTE_EMAIL, cliente.getNome());
    ...
    public ArrayList<Cliente> selecionaClientes(){
        ...
        while(c.moveToNext()){
            int id = c.getColumnIndex(ClientesContract.ClienteEntry._ID);
